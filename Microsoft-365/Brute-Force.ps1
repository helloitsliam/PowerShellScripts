...
##  Defines a list of usernames to test.                                                                                                    ##
##  Defines a list of passwords to test.                                                                                                    ##
##  Loops through the list of usernames and passwords, using the Test-MgUserPassword cmdlet to test each combination.                       ##
